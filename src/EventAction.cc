...
void EventAction::BeginOfEventAction(const G4Event* evt)
{
 ...
 fPointPix1ent = fPointPix1mid = fPointPix1ex = fPointDet1ent = fPointDet1entReal = fPointDet1mid = fPointDet1ex = fPointDet2ent = fPointDet2entReal = fPointDet2mid = fPointDet2ex = fPointPix2ent = fPointPix2mid = fPointPix2ex = G4ThreeVector(0, 0, 0);
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 B1 = G4ThreeVector((xAD.x())*(fPointDet1ent.z() - fPointPix1ent.z())/(xAD.z()) + fPointPix1ent.x(), (xAD.y())*(fPointDet1ent.z() - fPointPix1ent.z())/(xAD.z()) + fPointPix1ent.y(), fPointDet1ent.z());
